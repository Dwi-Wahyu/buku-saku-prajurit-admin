...
const breadcrumbMapping: Record<string, string> = {
  ...
  "/admin/penilaian": "Penilaian", // <-- Pastikan ini ada
  "/admin/penilaian/bak-pistol-15m": "Tembak Pistol 15m",
  "/admin/penilaian/kesegaran-jasmani": "Kesegaran Jasmani", // <-- Pastikan ini ada
  "/admin/penilaian/utp-umum-dan-jabatan": "UTP Umum & Jabatan", //
  "/admin/penilaian/latihan-satuan": "Latihan Satuan", //
  "/admin/penilaian/bak-tepat-100m": "BAK Tepat 100M", //

  "/admin/prajurit": "Prajurit", // Tambahkan jika ada
  "/admin/prajurit/create": "Input Prajurit", // Tambahkan jika ada
  "/admin/prajurit/edit": "Edit Prajurit", // Ini bisa jadi label umum jika ID dinamis
